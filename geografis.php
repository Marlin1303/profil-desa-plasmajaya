...
<div class="container">
    ...
    <h4 class="mb-3">Geografis Desa Plasma Jaya</h4>
    <div class=" d-flex justify-content-center">
        <img src="assets/img/Peta Desa.jpg" class="w-100 mb-3" alt="">
    </div>
    <div class="text-left">
        <h6 class="text-uppercase">Letak Wilayah</h6>
        <p>Plasma Jaya adalah sebuah desa yang berada di Kecamatan Polinggona, Kabupaten Kolaka, Provinsi Sulawesi Tenggara :</p>
