...
<div class="container">
    ...
    <h4 class="mb-3">Demografi Desa Plasma Jaya</h4>
    <div class=" d-flex justify-content-center">
        <img src="assets/img/Kantor Desa.jpg" class="w-100 mb-3" alt="">
    </div>
    <div class="text-left">
        <h6 class="text-uppercase">JUMLAH PENDUDUK DESA Plasma Jaya TAHUN 2024</h6>
