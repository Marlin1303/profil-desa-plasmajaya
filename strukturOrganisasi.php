    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-4">
                ...
                <a class="dropdown-item <?php echo ($detail == 'kaur_umum') ? 'active' : ''; ?>" href="?detail=kaur_umum">Kaur Umum</a>
                <a class="dropdown-item <?php echo ($detail == 'kaur_keuangan') ? 'active' : ''; ?>" href="?detail=kaur_keuangan">Kaur Keuangan</a>
                <a class="dropdown-item <?php echo ($detail == 'kaur_perencanaan') ? 'active' : ''; ?>" href="?detail=kaur_perencanaan">Kaur Perencanaan</a>
                <a class="dropdown-item <?php echo ($detail == 'kasi_pemerintahan') ? 'active' : ''; ?>" href="?detail=kasi_pemerintahan">Kasi Pemerintahan</a>
                <a class="dropdown-item <?php echo ($detail == 'kasi_pelayanan') ? 'active' : ''; ?>" href="?detail=kasi_pelayanan">Kasi pelayanan</a>
                ...
                <a class="dropdown-item <?php echo ($detail == 'kepala_dusun_V') ? 'active' : ''; ?>" href="?detail=kepala_dusun_V">Kepala Dusun V</a>
            </div>
            <div class="col-md-8">
                <?php if ($detail == 'struktur_organisasi') : ?>
                    <h2 class="text-left text-primary mb-2">Struktur Organisasi</h2>
                    <img src="assets/img/Struktur Organisasi.jpg" class="w-100" alt="">
                ...
                <?php elseif ($detail == 'kaur_umum') : ?>
                    <h2 class="text-left text-primary mb-2">Kaur Umum</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                ...
                <?php elseif ($detail == 'kaur_keuangan') : ?>
                    <h2 class="text-left text-primary mb-2">Kaur Keuangan</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>Bonefasinus Erikson Moang Poar</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
...
Selain itu, Kaur Perencanaan dan Kaur TU dan Umum juga dapat bekerja sama dalam hal-hal lain yang terkait dengan kepentingan desa, seperti penyusunan laporan pelaksanaan pembangunan desa dan penyelenggaraan pelayanan publik.</p>
                <?php elseif ($detail == 'kasi_pemerintahan') : ?>
                    ...
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
                            <td>Marontinus Romialdus Tufan</td>
                        </tr>
                        <tr>
                            <td>Nama Pejabat</td>
                            <td>:</td>
                ...
                <?php elseif ($detail == 'kasi_pelayanan') : ?>
...
Kepala urusan pemberdayaan masyarakat <br>
Perangkat dusun diangkat oleh kepala dusun setelah dikonsultasikan dengan kepala desa dan camat <br></p>
                <?php elseif ($detail == 'kepala_dusun_V') : ?>
                    <h2 class="text-left text-primary mb-2">Kepala Dusun V</h2>
                    <table class="table table-condensed">
                        <tr>
                            <td style="width: 150px;">Jabatan</td>
                            <td style="width: 5px;">:</td>
