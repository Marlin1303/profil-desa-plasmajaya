...
<nav class="navbar navbar-expand-lg p-3 navbar-light bg-light">
    <div class="container">
        <div class="d-flex align-items-center">
            <div class="navbar-brand text-dark"><img src="assets/img/Logo Kabupaten Kolak.png" width="50" alt="">
            </div>
            <div class="text-dark" style="text-decoration: none">
                <h6>Sistem Informasi Desa Plasma Jaya</h6>
                <h6 class="fw-normal">Polinggona, Kab. Kolaka</h6>
            </div>
        </div>
